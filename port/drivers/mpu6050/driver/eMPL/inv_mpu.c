...
#define delay_ms    mp_hal_delay_ms
#define get_ms(timestamp)      *timestamp = mp_hal_ticks_ms()
...
#if defined MPU6050
const struct gyro_reg_s reg = { //记录寄存器地址
    .who_am_i       = 0x75,
    .rate_div       = 0x19,
    .lpf            = 0x1A,
    .prod_id        = 0x0C,
