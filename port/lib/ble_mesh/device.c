...
void init_pub(void)
{
	...
	bt_mesh_pub_msg_light_lightness_srv_pub		= NET_BUF_SIMPLE(2 + 6);
	bt_mesh_pub_msg_light_lightness_cli_pub		= NET_BUF_SIMPLE(2 + 6);	
	// bt_mesh_pub_msg_light_ctl_srv_pub			= NET_BUF_SIMPLE(2 + 2);
	// bt_mesh_pub_msg_light_ctl_cli_pub			= NET_BUF_SIMPLE(2 + 2);
	bt_mesh_pub_msg_light_hsl_srv_pub			= NET_BUF_SIMPLE(2 + 9);
	// bt_mesh_pub_msg_light_hsl_cli_pub			= NET_BUF_SIMPLE(2 + 9);
	...
	// light_hsl_cli_pub.msg			= bt_mesh_pub_msg_light_hsl_cli_pub;
